            ...
            <div class="d-flex align-items-center">
                ...
                <div class="mobile-language-dropdown d-lg-none">
                    <div class="d-flex align-items-center">
                        ...
                        <a class="nav-link" href="/es/query.php">
                ...
                <ul class="navbar-nav ml-auto text-center" style="font-size: larger;">
                    ...
                    <li class="nav-item dropdown d-none d-lg-block"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown3" style="display: none;">
                            ...
                            <a class="dropdown-item" href="/es/query.php"
                                style="display: flex; justify-content: space-between; align-items: center;">
                                <font style="vertical-align: inherit;">
                            ...
                            <a class="dropdown-item" href="/query.php"
                                style="display: flex; justify-content: space-between; align-items: center;">
                                <font style="vertical-align: inherit;">
        ...
        <div class="container1">
            <div>
                <div class="section">
                    ...
                    <h1 class="main-title text-center mt-1" style=" font-size: 2rem;">
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">获取免费报价</font>
                        </font>
                    </h1>
                    <form action="process_form.php" method="POST">
                        ...
                        <label for="mobile">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">您的手机</font>
                            </font>
                        </label>
                        ...
                        <label for="service">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">选择服务</font>
                            </font>
                        </label>
                        <select id="service" name="service" required="">
                            ...
                            <option value="digital_marketing_consultancy">

                                数字营销咨询

                            </option>
                            <option value="digital_marketing_strategy_creation">

                                数字营销策略制定


                            </option>
                            <option value="website_design_and_development">
                            ...
                            <option value="vedio_production">

                                视频制作

                            </option>
                            <option value="photography_production">

                                摄影制作

                            </option>
                            <option value="pay_per_click">

                                按点击付费

                            </option>
                            <option value="ai_ads_generation">
