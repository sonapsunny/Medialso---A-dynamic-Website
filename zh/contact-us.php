    ...
    <script type="application/ld+json">
{
  ...
  "@type": "LocalBusiness",
  "name": "MEDIALSO",
  "image": "https://medialso.com/logo.png",
  "telephone": "+971 04 297 7303",
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "Single Business Tower, 250 Sheikh Zayed Rd",
  ...
  "priceRange": "$$"
    ...
    <title>联系我们 | MEDIALSO</title>
    <meta name="description"
        content="Contact Medialso for any Digital Marketing Services, Employment, Partnerships queries &amp; for RFP submissions.">
    <link rel="canonical" href="https://medialso.com/contact-us.php">
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="mobile-language-dropdown d-lg-none">
                    <div class="d-flex align-items-center">
                        ...
                        <a class="nav-link" href="/es/contact-us.php">
            ...
            <div class="navbar-collapse custom-collapse collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto text-center" style="font-size: larger;">
                    ...
                    <li class="nav-item dropdown d-none d-lg-block"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown3" style="display: none;">
                            <a class="dropdown-item" href="" onclick="translatePage('zh-CN')"
                                ...
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">中国人</font>
                            ...
                            <a class="dropdown-item" href="/es/contact-us.php"
                                style="display: flex; justify-content: space-between; align-items: center;">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">西班牙语</font>
                                </font><span style="margin-left: 10px;">
                                    <font style="vertical-align: inherit;">
                            ...
                            <a class="dropdown-item" href="/contact-us.php"
                                style="display: flex; justify-content: space-between; align-items: center;">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">英语</font>
                                </font><span style="margin-left: 10px;">
                                    <font style="vertical-align: inherit;">
                    ...
                    <!-- <img src="assets/alibabacloud.webp" alt="Alibaba Cloud" style="width: 100px; margin-left: 100rem;"> -->
                </ul>
            </div>
        </div>
    </nav>
    ...
    <section class="main-section">
        <div class="container1">
            <div class="left-section">
                <h1 class="main-title">
                    <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">准备好将您的营销提升至更高水平吗？</font>
                    </font>
                </h1>
                <p style="font-size:25px;">
                    <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">预订演示和探索电话以了解：</font>
                    </font>
                </p>
                <ul>
                    <li>
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">Medialso 的工作原理</font>
                        </font>
                    </li>
                    <li>
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">如何更好、更快、更便宜地进行大规模营销</font>
                        </font>
                    </li>
                    <li>
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">我们与代理机构、自由职业者和内部营销团队的不同之处（提示：我们的速度比招聘快 15 倍！）</font>
                        </font>
                    </li>
                    <li>
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">最适合您需求的订阅计划</font>
                        </font>
                    </li>
                </ul>
                <div class="logos">
                    <img loading="lazy" src="assets/Logitech.svg" alt="罗技">
                    <img loading="lazy" src="assets/Stripe.svg" alt="条纹">
                    <img loading="lazy" src="assets/HubSpot.svg" alt="HubSpot">
                    <img loading="lazy" src="assets/Burger-King.svg" alt="汉堡王">
                </div>
            </div>
            <div class="right-section">
                <h2>
                    <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">与我们预约通话</font>
                    </font>
                </h2>
                <form action="submit.php" method="POST">
                    ...
                    <label for="lastName">
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">姓*</font>
                        </font>
                    </label>
                    <input type="text" id="lastName" name="last_name" required="">
                    <label for="lastName">
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">电话号码*</font>
                        </font>
                    </label>
                    ...
                    <label for="workEmail">
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">工作电子邮箱*</font>
                        </font>
                    </label>
                    <input type="email" id="workEmail" name="work_email" required="">
                    <label for="budget">
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">您的每月预算是多少？*</font>
                        </font>
                    </label>
                    <select id="monthly_budget" name="monthly_budget" required="">
                        <option value="1-5000">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">$1-$5000</font>
                            </font>
                        </option>
                        <option value="5001-10000">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">$5001-$10000</font>
                            </font>
                        </option>
                        <option value="10001-30000">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">$10001-$30000</font>
                            </font>
                        </option>
                        <option value="30001-50000">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">$30001-$50000</font>
                            </font>
                        </option>
                        <option value="50001-100000">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">$50001-$100000</font>
                            </font>
                        </option>
                        <option value="100000+">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">10万美元以上</font>
                            </font>
                        </option>
                        <option value="0">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">尚未决定</font>
                            </font>
                        </option>
                    </select>
                    <label for="location">
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">地点*</font>
                        </font>
                    </label>
                    <select id="location" name="location" required="">
                        <option value="North_America">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">北美</font>
                            </font>
                        </option>
                        <option value="Western_Europe">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">西欧</font>
                            </font>
                        </option>
                        <option value="Middle_East">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">中东</font>
                            </font>
                        </option>
                        <option value="Asia_Pacific">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">亚太地区 (APAC)</font>
                            </font>
                        </option>
                        <option value="Other">
                            <font style="vertical-align: inherit;">
                    ...
                    <label for="tasks">
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">您想解决什么任务？</font>
                        </font>
                    </label>
