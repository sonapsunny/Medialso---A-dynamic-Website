    ...
    <script type="application/ld+json">
{
  ...
  "priceRange": "$$"
    ...
    <title>Contact Us | MEDIALSO</title>
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="mobile-language-dropdown d-lg-none">
                    <div class="d-flex align-items-center">
                        <a class="nav-link" href="/zh/contact-us.php">
                ...
                <ul class="navbar-nav ml-auto text-center" style="font-size: larger;">
                    <li class="nav-item dropdown" style="width: 150px; margin-top: 10px; text-align: left;">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown1">
                            <a class="dropdown-item" href="digital-marketing-services-dubai.html">Digital Marketing</a>
                            ...
                            <a class="dropdown-item" href="website-design-development-services.html">Website Design &
                                Development</a>
                            <a class="dropdown-item" href="social-media-agency-dubai.html">Social Media</a>
                            ...
                            <a class="dropdown-item" href="video-production-services.html">Video Production</a>
                            <a class="dropdown-item" href="photography-production-services.html">Photography
                                Production</a>
                            <a class="dropdown-item" href="pay-per-click-advertising.html">Pay Per Click</a>
                            <a class="dropdown-item" href="ai-ads-generation.html">AI Ads Generation</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown" style="margin-top: 10px; margin-left: 10px; text-align: left;">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
                            <a class="dropdown-item" href="b2b-marketing-agency.html">B2B Marketing</a>
                            ...
                            <a class="dropdown-item" href="real-estate-marketing.html">Real Estate</a>
                    ...
                    <li class="nav-item dropdown" style="width: 150px;  margin-top: 10px; text-align: left;">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown3">
                            ...
                            <a class="dropdown-item" href="pricing/digital-strategy-pricing.php">Digital Strategy</a>
                            <a class="dropdown-item" href="pricing/production-pricing.php">Production</a>
                            <a class="dropdown-item" href="pricing/ai-generated-contents-pricing.php">AI Generated
                                Contents</a>
                    ...
                    <li class="nav-item dropdown d-none d-lg-block"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown3">
                            <a class="dropdown-item" href="/zh/contact-us.php"
                    ...
                    <li>
                        <div class="desktop-only">
                            <a href="contact-us.php" class="btn view-work-btn mt-3 speak-to-us-btn"
                                style="font-size: large;">Speak To Us</a>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <section class="main-section1">
        <div class="container1">
            <div class="left-section">
                <h1 class="main-title">Ready to take your marketing to the next level?</h1>
                <p style="font-size:25px;">Book a demo and discovery call to get a look at:</p>
                <ul>
                    <li>How Medialso works</li>
                    <li>How you can do marketing at scale better, faster and cheaper</li>
                    <li>How we're different from agencies, freelancers and in-house marketing teams (hint: we're 15x
                        faster than hiring!)</li>
                    <li>The most suitable subscription plan for your needs</li>
                </ul>
                <div class="logos">
                    <img loading="lazy" src="assets/Logitech.svg" alt="Logitech">
                    <img loading="lazy" src="assets/Stripe.svg" alt="Stripe">
                    <img loading="lazy" src="assets/HubSpot.svg" alt="HubSpot">
                    <img loading="lazy" src="assets/Burger-King.svg" alt="Burger King">
                </div>
            </div>
            <div class="right-section">
                ...
                <form action="submit.php" method="POST">
                    ...
                    <label for="budget">What Is Your Monthly Budget?*</label>
                    <select id="monthly_budget" name="monthly_budget" required>
                        ...
                        <option value="0">Haven't decided Yet</option>
                    </select>
                    ...
                    <select id="location" name="location" required>
                        ...
                        <option value="Asia_Pacific">Asia Pacific (APAC)</option>
                        <option value="Other">Other</option>
                    </select>
                    <label for="tasks">What tasks would you like to solve?</label>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="automotive-marketing-services.html">Automotive</a></li>
            ...
            <div class="row">
                <div class="col text-center">
                    <p style="color: #bdbdbd;">&copy; 2024 Medialso. All rights reserved. <a href="#">Privacy Policy</a>
                        | <a href="#">Terms & Conditions</a> | <a href="https://www.drt-seagull.com/">Seagull DRT</a>
                    </p>
                </div>
            </div>
        </div>
