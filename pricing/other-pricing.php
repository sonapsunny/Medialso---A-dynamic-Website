...
<head>
    ...
    <title>Other Digital Services Pricing | MEDIALSO</title>
...
<body>
    ...
    <section class="main-section">
        <div class="container">
            <h1 class="main-title text-center">Other Digital Services Pricing</h1>
        ...
        <div class="pricing-table mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="tick">Media Relation</p>
                    <p class="tick">Press Release</p>
                    <p class="tick">Crisis Management</p>
                    <p class="tick">Reputation Management</p>
                    <p class="tick">Content Development</p>
                    <p class="tick">influencer Partnership</p>
                    <a href="../contact-us.php" class="btn view-work-btn mt-1">Book a call</a>
                </div>
            </div>
            <div class="card">
                <div class="card-header">Event Management</div>
                <div class="card-body">
                    <p class="tick">Event Planning</p>
                    <p class="tick">Vendor Management</p>
                    <p class="tick">Event Design & Production</p>
                    <p class="tick">Content Creation</p>
                    <p class="tick">Public Relation</p>
                    <br><br><br>
