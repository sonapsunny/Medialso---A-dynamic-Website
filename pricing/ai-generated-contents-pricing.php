...
<head>
    ...
    <title>AI Generated Content Services Pricing | MEDIALSO</title>
...
<body>
    ...
    <section class="main-section">
        <div class="container">
            <h1 class="main-title text-center">AI Generated Content Services Pricing</h1>
                        ...
                        <table class="table table-bordered text-center">
                            <thead>
                                <tr style="font-size: 2rem; color: #6C63FF;">
                                    <th>AI Generated Contents</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <th scope="row">AI Powered Copywriting</th>
                                    <td rowspan="12"
                                        ...
                                        <div class="d-flex justify-content-center mb-5">
                                            <a href="../contact-us.php" class="btn view-work-btn mt-3 "
                                                style="font-size: large;">GET A QUOTE</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">AI Generated Content Calender</th>
                                </tr>
                                <tr>
                                    <th scope="row">Content Personalization</th>
                                </tr>
                                <tr>
                                    <th scope="row">Content Summarization</th>
                                </tr>
                                <tr>
                                    <th scope="row">Keyword Integration</th>
                                </tr>
                            </tbody>
                        </table>
