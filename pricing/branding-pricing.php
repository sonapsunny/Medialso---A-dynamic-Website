...
<head>
    ...
    <title>Professional Branding Services Pricing | MEDIALSO</title>
...
<body>
    ...
    <section class="main-section">
        <div class="container">
            <h1 class="main-title text-center">Branding Services Pricing</h1>
                ...
                <div class="col-12">
                    ...
                    <div class="table-responsive d-none d-md-block">
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">Logo Identity</th>
                                    <td>1</td>
                                    <td>2 & Working File (PSD, AI)</td>
                                    <td>3 & Working File (PSD, AI)</td>
                                </tr>
                                <tr>
                                    <th scope="row">Brand Guidelines</th>
                                    <td><span class="tick-mark">&#10004;</span></td>
                                    <td><span class="tick-mark">&#10004;</span></td>
                                    <td><span class="tick-mark">&#10004;</span></td>
                                </tr>
                                <tr>
                                    <th scope="row">Stationaries</th>
                                    <td>Business card, Letter Head, Envelop</td>
                                    <td>Business card, Letter head, Envelop, <br> Flyers, Menu, Brand Profile</td>
                                    <td>Business card, Letter head, Envelop, <br>Flyers, Menu, Brand Profile</td>
                                </tr>
                                <tr>
                                    <th scope="row">Mockups</th>
                                    <td>Social Media and Website</td>
                                    <td>Social Media and Website</td>
                                    <td>Social Media and Website</td>
                                </tr>
                                <tr>
                            ...
                            <div class="carousel-item active">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">$1,500 per month</p>
                                        <ul class="list-unstyled">
                                            <li>Logo Identity: 1</li>
                                            <li>Brand Guidelines <span class="tick-mark">&#10004;</span></li>
                                            <li>Stationaries: Business card, Letter Head, Envelop</li>
                                            <li>Mockups: Social Media and Website</li>
                                            <li>Delivery Time: 1-2 Weeks</li>
                                            <li>Concept: One Concept</li>
                                            <li>Revision: 2 Revision</li>
                                        </ul>
                            ...
                            <div class="carousel-item">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">$2,500 per month</p>
                                        <ul class="list-unstyled">
                                            <li>Logo Identity: 2 & Working File (PSD, AI)</li>
                                            <li>Brand Guidelines <span class="tick-mark">&#10004;</span></li>
                                            <li>Stationaries: Business card, Letter head, Envelop, Flyers, Menu, Brand
                                                Profile</li>
                                            <li>Mockups: Social Media and Website</li>
                                            <li>Delivery Time: 2-3 Weeks</li>
                                            <li>Concept: Two Concept</li>
                                            <li>Revision: 4 Revision</li>
                                        </ul>
                                        <a href="../contact-us.php" class="btn view-work-btn">GET STARTED</a>
                                    </div>
                                </div>
                            ...
                            <div class="carousel-item">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">$3,500 per month</p>
                                        <ul class="list-unstyled">
                                            <li>Logo Identity: 3 & Working File (PSD, AI)</li>
                                            <li>Brand Guidelines <span class="tick-mark">&#10004;</span></li>
                                            <li>Stationaries: Business card, Letter head, Envelop, Flyers, Menu, Brand
                                                Profile</li>
                                            <li>Mockups: Social Media and Website</li>
                                            <li>Delivery Time: 1 Month</li>
                                            <li>Concept: Three Concept</li>
                                            <li>Revision: 6 Revision</li>
                                        </ul>
                                        <a href="../contact-us.php" class="btn view-work-btn">GET STARTED</a>
                                    </div>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Logo Identity</label>
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="psd" name="logoIdentity[]"
                                        value="PSD">
                                    <label class="form-check-label" for="psd">PSD</label>
                                </div>
                                <div class="form-check form-check-inline">
                        ...
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Brand Guidelines</label>
                            <div class="input-group">
                        ...
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Stationaries</label>
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="businessCard"
                                        name="stationaries[]" value="business card">
                                    <label class="form-check-label" for="businessCard">Business Card</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="flyers" name="stationaries[]"
                                        value="Flyers">
                                    <label class="form-check-label" for="flyers">Flyers</label>
                                </div>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="letterHead" name="stationaries[]"
                                    value="Letter Head">
                                <label class="form-check-label" for="letterHead">Letter Head</label>
                            </div>
                            <div class="form-check form-check-inline">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="envelop" name="stationaries[]"
                                    value="Envelop">
                                <label class="form-check-label" for="envelop">Envelop</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="brandProfile" name="stationaries[]"
                                    value="Brand Profile">
                                <label class="form-check-label" for="brandProfile">Brand Profile</label>
                            </div>
                        </div>

                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Mockups</label>
                            <div class="input-group">
                        ...
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Revision(s)</label>
                            <div class="input-group">
