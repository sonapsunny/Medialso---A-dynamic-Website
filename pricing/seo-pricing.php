...
<head>
    ...
    <title>Affordable SEO Services Pricing | MEDIALSO</title>
...
<body>
    ...
    <section class="main-section">
        <div class="container">
            <h1 class="main-title text-center">SEO Services Pricing</h1>
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Identification of key phrases relevant to your industry</td>
                                    <td>Comprehensive keyword research and strategy development</td>
                                    <td>In-depth keyword research and development of a tailored strategy</td>
                                </tr>
                                <tr>
                                    <th scope="row">On Page SEO</th>
                                    <td>Optimization of 10 pages including meta tags, headers and images</td>
                                    <td>Optimization of 20 pages including meta tags, headers and images</td>
                                    <td>Optimization of up to 40 pages including meta tags, headers, images, and
                                        internal linking</td>
                                </tr>
                                <tr>
                                    <th scope="row">Technical SEO Audit</th>
                                    <td>Basic technical audit to identify and fix core issues</td>
                                    <td>Detailed technical audit with prioritized fixes</td>
                                    <td>Comprehensive technical audit, ongoing monitoring and fixes</td>
                                </tr>
                                <tr>
                                    <th scope="row">Content Optimization</th>
                                    <td>Optimization of existing content for SEO best practices</td>
                                    <td>Creation of 2 blog posts per month, and optimization of existing content</td>
                                    <td>Creation of 4 blog posts per month, content gap analysis, and optimization of
                                        existing content</td>
                                </tr>
                                <tr>
                                    <th scope="row">Local SEO</th>
                                    <td>Google My Business setup and optimization</td>
                                    <td>Google My Business setup, optimization, and local citation building</td>
                                    <td>Advanced local SEO tactics, including local citation building and reviews
                                        management</td>
                                </tr>
                                <tr>
                                    <th scope="row">Link Building</th>
                                    <td>-</td>
                                    <td>Monthly link-building activities focusing on high-quality backlinks</td>
                                ...
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled">
                                            <li>Keyword Research: Identification of key phrases relevant to your
                                                industry</li>
                                            <li>On Page SEO: Optimization of 10 pages including meta tags, headers and
                                                images</li>
                                            <li>Technical SEO Audit: Basic technical audit to identify and fix core
                                                issues</li>
                                            <li>Content Optimization: Optimization of existing content for SEO best
                                                practices</li>
                                            <li>Local SEO: Google My Business setup and optimization</li>
                                            <li>Link Building: -</li>
            ...
            <form id="pricing-form" action="seo-custom-pricing.php" method="post">
                <div class="card">
                    <div class="card-header">
                        Customize Search Engine Optimization package
                    </div>
                    <div class="card-body">
                        <!-- New input fields -->
                        ...
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Keyword Research</label>
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="keyPhrases" name="keyword[]"
                                        value="Identification of key phrases">
                                    <label class="form-check-label" for="keyPhrases">Identification of key
                                        phrases</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="keywordResearch"
                                        name="keyword[]" value="Comprehensive keyword research">
                                    <label class="form-check-label" for="keywordResearch">Comprehensive keyword
                                        research</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="strategy" name="keyword[]"
                                        value="Advanced keyword research & strategy">
                                    <label class="form-check-label" for="strategy">Advanced keyword research &
                                        strategy</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">On-Page Search Engine
                                Optimization</label>
                        ...
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Technical SEO Audit</label>
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="basic" name="audit[]"
                                        value="Basic Technical Audit">
                                    <label class="form-check-label" for="basic">Basic Technical Audit</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="detailed" name="audit[]"
                                        value="Detailed Technical Audit">
                                    <label class="form-check-label" for="detailed">Detailed Technical Audit</label>
                                </div>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="comprehensive" name="audit[]" value="Comprehensive Technical
                                    Audit">
                                <label class="form-check-label" for="comprehensive">Comprehensive Technical
                                    Audit</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Content Optimization</label>
                            <div class="input-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="optimise" name="content[]" value="Optimization of existing content for SEO
                                    best practices">
                                <label class="form-check-label" for="optimise">Optimization of existing content for SEO
                                    best practices</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Local Search Engine Optimization</label>
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="businessSetup"
                                        name="optimization[]" value="Google business setup & optimization">
                                    <label class="form-check-label" for="businessSetup">Google business setup &
                                        optimization</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="optimization">Google business setup,
                                        optimization & local citation building</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="tactics" name="optimization[]"
                                        value="Advance local SEO tactics">
                                    <label class="form-check-label" for="tactics">Advance local SEO tactics</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Link Building</label>
                            <div>
                                <div class="form-check form-check-inline">
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="monthly">Monthly link-building</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="aggressive" name="building[]"
                                        value="Aggressive link-building">
                                    <label class="form-check-label" for="aggressive">Aggressive link-building</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Competitor Analysis</label>
                            <div>
                                <div class="form-check form-check-inline">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="regular" name="analysis[]"
                                        ...
                                        competitors">
                                    <label class="form-check-label" for="regular">Regular analysis of
                                        competitors</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Monthly Report</label>
                            <div>
                                <div class="form-check form-check-inline">
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="reports">Basic performance reports</label>
                                </div>
                            </div>
                        </div>
                    </div>
