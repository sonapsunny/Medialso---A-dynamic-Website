...
<head>
    ...
    <title>Production Services Pricing | MEDIALSO</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="mobile-language-dropdown d-lg-none">
                    <div class="d-flex align-items-center">
                        <a class="nav-link" href="/zh/pricing/production-pricing.php">
    ...
    <section class="main-section">
        <div class="container">
            <h1 class="main-title text-center">Production Services Pricing</h1>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">Color Grading</th>
                                </tr>
                                <tr>
                                    <th scope="row">Mood Boarding</th>
                                </tr>
                                <tr>
                                    <th scope="row">Story Boarding</th>
                                </tr>
                                <tr>
                                    <th scope="row">Script Writing</th>
                                </tr>
                                <tr>
