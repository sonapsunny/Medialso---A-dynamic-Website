...
<head>
    ...
    <title>Affordable Social Media Management Services | MEDIALSO</title>
...
<body>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="mobile-language-dropdown d-lg-none">
                    <div class="d-flex align-items-center">
                        ...
                        <a class="nav-link" href="/es/pricing/social-media-management-pricing.php">
    ...
    <section class="main-section">
        <div class="container">
            <h1 class="main-title text-center">Social Media Management Pricing</h1>
        ...
        <div class="container my-5">
            ...
            <div class="row">
                <div class="col-12">
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="tick-mark">&#10004;</span></td>
                                    <td><span class="tick-mark">&#10004;</span></td>
                                    <td><span class="tick-mark">&#10004;</span></td>
                                    <td>Consultation with CEO</td>
                                </tr>
                                <tr>
                                    <th scope="row">Content Strategy, Report</th>
                                    <td>Monthly</td>
                                    <td>Monthly</td>
                                    <td>Monthly</td>
                                    <td>Monthly</td>
                                ...
                                <tr>
                                    <th scope="row">Social Channel</th>
                                    <td>2-3</td>
                                    <td>3</td>
                                    <td>4</td>
                                    <td>6+</td>
                                ...
                                <tr>
                                    <th scope="row">Post Per Month</th>
                                    <td>8-9</td>
                                    <td>12-13</td>
                                    <td>16-18</td>
                                    <td>30-31</td>
                                ...
                                <tr>
                                    <th scope="row">Custom Graphic & Animation</th>
                                    <td>3-5</td>
                                    <td>5-7</td>
                                    <td>6-9</td>
                                    <td>15-20</td>
                                ...
                                <tr style="font-size: 2rem; font-weight: 600;">
                                    <th></th>
                                    <td style="color: #6C63FF;">$800 <br>
                                        <div class="d-flex justify-content-center mb-5">
                                            <a href="../contact-us.php" class="btn view-work-btn mt-3"
                                                style="font-size: large;">GET STARTED</a>
                                        </div>
                                    </td>
                                    <td style="color: #6C63FF;">$1,200 <br>
                                        <div class="d-flex justify-content-center mb-5">
                                            <a href="../contact-us.php" class="btn view-work-btn mt-3"
                                                style="font-size: large;">GET STARTED</a>
                                        </div>
                                    </td>
                                    <td style="color: #6C63FF;">$1,800 <br>
                                        <div class="d-flex justify-content-center mb-5">
                                            <a href="../contact-us.php" class="btn view-work-btn mt-3"
                                                style="font-size: large;">GET STARTED</a>
                                        </div>
                                    </td>
                                    <td><a href="../contact-us.php" class="btn view-work-btn"
                                            style="font-size: large;">Get
                                            a Quote</a></td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div id="pricingCarousel" class="carousel slide d-md-none" data-ride="false">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <h5 class="card-title">BASIC</h5>
                                        <p class="card-text">$800 per month</p>
                                        <ul class="list-unstyled">
                                            <li>Consultation <span class="tick-mark"
                                                    style="color: #6C63FF;">&#10004;</span></li>
                                            <li>Content Strategy, Report: Monthly</li>
                                            <li>Social Channel: 2-3</li>
                                            <li>Post Per Month: 8-9</li>
                                            <li>Custom Graphic & Animation: 3-5</li>
                                            <li>Community Management: 45 min</li>
                                            <li>Audience Engagement: 30 min</li>
                                        </ul>
                            ...
                            <div class="carousel-item">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">$1,200 per month</p>
                                        <ul class="list-unstyled">
                                            <li>Consultation <span class="tick-mark"
                                                    style="color: #6C63FF;">&#10004;</span></li>
                                            <li>Content Strategy, Report: Monthly</li>
                                            <li>Social Channel: 3</li>
                                            <li>Post Per Month: 12-13</li>
                                            <li>Custom Graphic & Animation: 5-7</li>
                                            <li>Community Management: 1 hour</li>
                                            <li>Audience Engagement: 45 min</li>
                                        </ul>
                                        <a href="../contact-us.php" class="btn view-work-btn">GET STARTED</a>
                                    </div>
                                </div>
                            ...
                            <div class="carousel-item">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">$1,800 per month</p>
                                        <ul class="list-unstyled">
                                            <li>Consultation <span class="tick-mark"
                                                    style="color: #6C63FF;">&#10004;</span></li>
                                            <li>Content Strategy, Report: Monthly</li>
                                            <li>Social Channel: 4</li>
                                            <li>Post Per Month: 16-18</li>
                                            <li>Custom Graphic & Animation: 6-9</li>
                                            <li>Community Management: 2 hours</li>
                                            <li>Audience Engagement: 1 hour</li>
                                        </ul>
                                        <a href="../contact-us.php" class="btn view-work-btn">GET STARTED</a>
                                    </div>
                                </div>
                            ...
                            <div class="carousel-item">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <h5 class="card-title">PREMIUM +</h5>
                                        <p class="card-text">Get a Quote</p>
                                        <ul class="list-unstyled">
                                            <li>Consultation with CEO</li>
                                            <li>Content Strategy, Report: Monthly</li>
                                            <li>Social Channel: 6+</li>
                                            <li>Post Per Month: 30-31</li>
                                            <li>Custom Graphic & Animation: 15-20</li>
                                            <li>Community Management: 4 hours</li>
                                            <li>Audience Engagement: 3 hours</li>
                                        </ul>
                                        <a href="../contact-us.php" class="btn view-work-btn">Get a Quote</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- <a class="carousel-control-prev" href="#pricingCarousel" role="button" data-slide="prev">
                            ...
                            <span class="sr-only" style="color: #000"><i class='bx bx-chevron-left'></i></span>
                        </a>
                        <a class="carousel-control-next" href="#pricingCarousel" role="button" data-slide="next">
                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                            <span class="sr-only" style="color: #000"><i class='bx bx-chevron-right'></i></span>
                        </a> -->
                    </div>
                </div>
            </div>
            ...
            <form id="pricing-form" action="social-media-management-custom-pricing.php" method="POST">
                ...
                <div class="card">
                    <div class="card-header">
                        Customize the Social Media Management package
                    </div>
                    <div class="card-body">
                        <!-- New input fields -->
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="normalConsultation">Normal Consultation</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="ceoConsultation"
                                        name="consultation[]" value="Consultation with CEO">
                                    <label class="form-check-label" for="ceoConsultation">Consultation with CEO</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Content Strategy -->
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Content Strategy, Report</label>
                        ...
                        <!-- Post Per Month -->
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Post Per Month</label>
                            <div class="input-group">
                        ...
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Custom Graphic & Animation</label>
                            <div class="input-group">
                        ...
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Community Management</label>
                            <div class="d-flex">
                        ...
                        <!-- Audience Engagement -->
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Audience Engagement</label>
                            <div class="d-flex">
                                <div class="input-group mr-2">
                                    <div class="input-group-prepend"
    ...
    <script>$(document).ready(function () { $("#navbarDropdown1, #navbarDropdown2, #navbarDropdown3").click(function (event) { event.preventDefault(); var dropdownMenu = $(this).next(".dropdown-menu"); $(".dropdown-menu").not(dropdownMenu).hide(); dropdownMenu.toggle() }); $(document).click(function (event) { var target = $(event.target); if (!target.closest(".nav-item.dropdown").length) { $(".dropdown-menu").hide() } }) });</script>
    ...
    <script>
        // Disable automatic cycling of the carousel
