...
<head>
    ...
    <title>Website Design and Development Pricing | MEDIALSO</title>
    <meta name="description"
        content="Discover our pricing for top-notch website design and development services. Create a stunning online presence with our expert team." />
    <link rel="canonical" href="https://medialso.com/pricing/web-development-and-design-pricing.php" />
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="mobile-language-dropdown d-lg-none">
                    <div class="d-flex align-items-center">
                        <a class="nav-link" href="/zh/pricing/web-development-and-design-pricing.php">
                            <img src="https://flagcdn.com/w20/cn.png" alt="Chinese">
                        </a>
                        <a class="nav-link" href="/es/pricing/web-development-and-design-pricing.php">
                ...
                <ul class="navbar-nav ml-auto text-center" style="font-size: larger;">
                    <li class="nav-item dropdown" style="width: 150px; margin-top: 10px; text-align: left;">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown1">
                            ...
                            <a class="dropdown-item" href="../pay-per-click-advertising.html">Pay
                                Per
                                Click</a>
                    ...
                    <li class="nav-item" style="width: 200px; margin-top: 10px; margin-left: 10px; text-align: left;">
                        <a class="nav-link" href="../medialso-portfolio.html" style="margin-right: 0px;">Case
                            Studies</a>
                    </li>
                    <li class="nav-item dropdown" style="width: 150px;  margin-top: 10px; text-align: left;">
    ...
    <section class="main-section">
        <div class="container">
            <h1 class="main-title text-center">Website Design and Development Pricing</h1>
            <p class="main-description text-center">
                Grab the hours you need and use them however you fancy. <br> With our all-inclusive monthly
                subscription, <br>
                there are no hidden costs or surprise charges. Just pure marketing magic.
            </p>
        </div>
        <div class="container my-5">
            <h2 class="text-center">Set up your site, pick a plan later</h2>
            <p class="text-center">Simple plans. Simple prices. Only pay for what you really need. All plans come with
                award-winning 24/7 customer support. Change or cancel your plan at any time.</p>
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Initial Project Consultation <br>Requirement Analysis</td>
                                    <td>Initial Project Consultation<br>Requirement Analysis <br>Project planning and
                                        timeline</td>
                                    <td>Initial Project Consultation<br>Requirement Analysis <br>Detailed Project
                                        planning and timeline <br>Competitive Analysis</td>
                                </tr>
                                <tr>
                                    <th scope="row">Design</th>
                                    <td>Basic Website Design <br>Up to 3 Pages <br>Mobile-Responsive Design</td>
                                    <td>Custom Website Design <br>Up to 10 Pages <br>Mobile-Responsive Design <br>Basic
                                        logo design</td>
                                    <td>Custom Website Design <br>Unlimited Pages <br>Mobile-Responsive Design <br>Logo
                                        and brand identity design <br>UX/UI design consultation</td>
                                </tr>
                                <tr>
                                    <th scope="row">Development</th>
                                    <td>HTML, CSS, Basic JavaScript <br>Static Website</td>
                                    <td>HTML, CSS, JavaScript, CMS(e.g.,WordPress) <br>Dynamic Website with CMS
                                        integration <br>Blog setup <br>Basic e-commerce (up to 10 products)
                                        <br>SEO-friendly URL structure
                                    </td>
                                    <td>HTML, CSS, JavaScript, advanced frameworks (React, Next.js) <br>Full-Stack
                                        Development (Node.js, MongoDB) <br>Custom CMS or integration with existing CMS
                                        <br>Advanced e-commerce (unlimited products) <br>Payment gateway integration
                                        <br>SEO optimization
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">Hosting & Domain</th>
                                    <td>Free domain registration for 1 year <br>Basic shared hosting for 1 year</td>
                                    <td>Free domain registration for 1 year <br>Standard shared hosting for 1 year
                                        <br>SSL Certificate
                                    </td>
                                    <td>Free domain registration for 2 years <br>Premium hosting (VPS or dedicated
                                        server) for 1 year <br>SSL Certificate <br>CDN Integration</td>
                                </tr>
                                <tr>
                                    <th scope="row">Support</th>
                                    <td>1 month of email support <br>Basic training session</td>
                                    <td>3 months of email and phone support <br>Basic training session <br>Website
                                        maintenance for 3 months</td>
                                    <td>6 months of email, phone and chat support <br>Detailed training sessions
                                        <br>Website maintenance for 6 months <br>Analytics setup and monthly reporting
                                    </td>
                                </tr>
                                <tr style="font-size: 2rem; font-weight: 600;">
                                    <th></th>
                                    <td style="color: #6C63FF;">$999 <br>
                                        <div class="d-flex justify-content-center mb-5">
                                            <a href="../contact-us.php" class="btn view-work-btn mt-3"
                                                style="font-size: large;">GET STARTED</a>
                                        </div>
                                    </td>
                                    <td style="color: #6C63FF;">$2,499 <br>
                                        <div class="d-flex justify-content-center mb-5">
                                            <a href="../contact-us.php" class="btn view-work-btn mt-3"
                                                style="font-size: large;">GET STARTED</a>
                                        </div>
                                    </td>
                                    <td style="color: #6C63FF;">$5,999 <br>
                                        <div class="d-flex justify-content-center mb-5">
                                            <a href="../contact-us.php" class="btn view-work-btn mt-3"
                                                style="font-size: large;">GET STARTED</a>
                                        </div>
                                ...
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li>Basic shared hosting for 1 year</li>
                                            <li>1 month of email support</li>
                                ...
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li>HTML, CSS, JavaScript, CMS (e.g., WordPress)</li>
                                            <li>Dynamic Website with CMS integration</li>
                                            <li>Blog setup</li>
                                            <li>Basic e-commerce (up to 10 products)</li>
                                            <li>SEO-friendly URL structure</li>
                                            <li>Free domain registration for 1 year</li>
                                            <li>Standard shared hosting for 1 year</li>
                                            <li>SSL Certificate</li>
                                            <li>3 months of email and phone support</li>
                                            <li>Basic training session</li>
                                ...
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li>HTML, CSS, JavaScript, advanced frameworks (React, Next.js)</li>
                                            <li>Full-Stack Development (Node.js, MongoDB)</li>
                                            <li>Custom CMS or integration with existing CMS</li>
                                            <li>Advanced e-commerce (unlimited products)</li>
                                            <li>Payment gateway integration</li>
                                            <li>SEO optimization</li>
                                            <li>Free domain registration for 2 years</li>
                                            <li>Premium hosting (VPS or dedicated server) for 1 year</li>
                                            <li>SSL Certificate</li>
                                            <li>CDN Integration</li>
                                            <li>6 months of email, phone and chat support</li>
                                            <li>Detailed training sessions</li>
                                            <li>Website maintenance for 6 months</li>
                                            <li>Analytics setup and monthly reporting</li>
                                        </ul>
                                        <a href="../contact-us.php" class="btn view-work-btn">GET STARTED</a>
                                    </div>
                                </div>
        ...
        <div class="container">
            ...
            <form id="pricing-form" action="web-development-and-design-custom-pricing.php" method="POST">
                <div class="card">
                    <div class="card-header">
                        Customize Website Design & Development package
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="name" class="col-sm-3 col-form-label"
                                style="font-size: larger; font-weight: 600; text-align: left; color: #000;">Name</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="companyName" class="col-sm-3 col-form-label"
                                style="font-size: larger; font-weight: 600;text-align: left;color: #000;">Company
                                Name</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-sm-3 col-form-label"
                                style="font-size: larger; font-weight: 600;text-align: left; color: #000;">Phone</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-sm-3 col-form-label"
                                style="font-size: larger; font-weight: 600;text-align: left; color: #000;">Email</label>
                            <div class="col-sm-9">
                                <input type="email" class="form-control" id="email" name="email" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Consultation</label>
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="initial" name="consultation[]"
                                        value="Initial Project Consultation">
                                    <label class="form-check-label" for="initial">Initial Project Consultation</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="analysis" name="consultation[]"
                                        value="Requirement Analysis">
                                    <label class="form-check-label" for="analysis">Requirement Analysis</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="planning" name="consultation[]"
                                        value="Detailed Project Planning and
                                        Timeline">
                                    <label class="form-check-label" for="planning">Detailed Project Planning and
                                        Timeline</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="competitive"
                                        name="consultation[]" value="Competitive Analysis">
                                    <label class="form-check-label" for="competitive">Competitive Analysis</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Design</label>
                            <div class="form-group">
                                <label for="pages">Pages</label>
                                <div class="input-group">
                                    <div class="input-group-prepend" onclick="updateValue('pages', -1)">
                                        <span class="input-group-text">-</span>
                                    </div>
                                    <input type="text" class="form-control text-center" id="pages" name="pages"
                                        value="1" readonly>
                                    <div class="input-group-append" onclick="updateValue('pages', 1)">
                                        <span class="input-group-text">+</span>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="unlimited" name="design[]"
                                        value="Unlimited Pages">
                                    <label class="form-check-label" for="unlimited">Unlimited Pages</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="basic" name="design[]"
                                        value="Basic Logo Design">
                                    <label class="form-check-label" for="basic">Basic Logo Design</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="logo" name="design[]"
                                        value="Logo and Brand Identity">
                                    <label class="form-check-label" for="logo">Logo and Brand Identity</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="ui" name="design[]"
                                        value="UI/UX Consultation">
                                    <label class="form-check-label" for="ui">UI/UX Consultation</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Development</label>
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="static" name="development[]"
                                        value="Static Website">
                                    <label class="form-check-label" for="static">Static Website</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="dynamic" name="development[]"
                                        value="Dynamic Website with CMS">
                                    <label class="form-check-label" for="dynamic">Dynamic Website with CMS</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="fullStack" name="development[]"
                                        value="Full Stack Development">
                                    <label class="form-check-label" for="fullStack">Full Stack Development</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="html" name="development[]"
                                        value="HTML">
                                    <label class="form-check-label" for="html">HTML</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="css" name="development[]"
                                        value="CSS">
                                    <label class="form-check-label" for="css">CSS</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="javascript" name="development[]"
                                        value="JavaScript">
                                    <label class="form-check-label" for="javascript">JavaScript</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="cms" name="development[]"
                                        value="CMS">
                                    <label class="form-check-label" for="cms">CMS</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="basicjs" name="development[]"
                                        value="Basic JS">
                                    <label class="form-check-label" for="basicjs">Basic JS</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="advanced" name="development[]"
                                        value="Advanced Framework">
                                    <label class="form-check-label" for="advanced">Advanced Framework</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="blog" name="development[]"
                                        value="Blog Setup">
                                    <label class="form-check-label" for="blog">Blog Setup</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="custom" name="development[]"
                                        value="Custom CMS or integration with existing
                                    CMS">
                                    <label class="form-check-label" for="custom">Custom CMS or integration with existing
                                        CMS</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="quantity">Basic E-Commerce (Product Qty.)</label>
                                <div class="input-group">
                                    <div class="input-group-prepend" onclick="updateValue('quantity', -1)">
                                        <span class="input-group-text">-</span>
                                    </div>
                                    <input type="text" class="form-control text-center" id="quantity" name="quantity"
                                        value="1" readonly>
                                    <div class="input-group-append" onclick="updateValue('quantity', 1)">
                                        <span class="input-group-text">+</span>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="advance" name="development[]"
                                        value="1">
                                    <label class="form-check-label" for="advance">Advance E-Commerce (Unlimited
                                        Products)</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="seo" name="seo"
                                        value="SEO-Friendly URL">
                                    <label class="form-check-label" for="seo">SEO-Friendly URL</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="optimize" name="development[]"
                                        value="SEO Optimization">
                                    <label class="form-check-label" for="optimize">SEO Optimization</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label style="font-size: larger; font-weight: 600;">Hosting and Domain</label>
                            <div class="form-group">
                                <label for="free">Free domain registration for year(s)</label>
                                <div class="input-group">
                                    <div class="input-group-prepend" onclick="updateValue('free', -1)">
                                        <span class="input-group-text">-</span>
                                    </div>
                                    <input type="text" class="form-control text-center" id="free" name="free" value="1"
                                        readonly>
                                    <div class="input-group-append" onclick="updateValue('free', 1)">
                                        <span class="input-group-text">+</span>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="basicHosting" name="hosting[]"
                                        value="Basic shared hosting for 1
                                        year">
                                    <label class="form-check-label" for="basicHosting">Basic shared hosting for 1
                                        year</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="standardHosting"
                                        name="hosting[]" value="Standard shared hosting for 1
                                        year">
                                    <label class="form-check-label" for="standardHosting">Standard shared hosting for 1
                                        year</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="premium" name="hosting[]"
                                        value="Premium hosting for 1 year">
                                    <label class="form-check-label" for="premium">Premium hosting for 1 year</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="ssl" name="hosting[]"
                                        value="SSL Certificate">
                                    <label class="form-check-label" for="ssl">SSL Certificate</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="cdn" name="hosting[]"
                                        value="CDN Integration">
                                    <label class="form-check-label" for="cdn">CDN Integration</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="btn-group">
                        <button type="submit" class="btn view-work-btn">Get Quote</button>
                    </div>
                </div>
            </form>
        </div>
            ...
            <div class="row">
                <div class="col-md-2 col-sm-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="../website-design-development-services.html">Website Design and Development</a>
                        </li>
